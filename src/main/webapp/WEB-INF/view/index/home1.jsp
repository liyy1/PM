        ...
        <div class="layui-card">
          ...
          <div class="layui-card-body">
            <dl class="layuiadmin-card-status">
              <dd>
                <div class="layui-status-img"><a href="javascript:;"><img src="/my/layuiadmin/style/res/logo.png"></a></div>
                <div>
            ...
            <ul class="layui-row layuiadmin-card-team">
              <li class="layui-col-xs6">
                <a lay-href="http://www.layui.com/doc/modules/table.html">
                  <span class="layui-team-img"><img src="/my/layuiadmin/style/res/logo.png"></span> 
                  <span>数据表格</span>
                </a>
              </li>
              <li class="layui-col-xs6">
