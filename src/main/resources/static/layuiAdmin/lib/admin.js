        ...
        F = {
            ...
            popupR: function (e) {
                ...
                return layer.open(a.extend({
                    ...
                    shadeClose: !0,
                    area: "800px",
                    skin: "layui-anim layui-anim-rl layui-layer-adminR",
                    success: function () { n(this.id).content(e.url); }
                },e));
            },
            ...
            tabsBodyChange: function (e, a) {
                a = a || {},
                    ...
                    P.rollPage("auto", e),
                    layui.event.call(this, l.MOD_NAME, "tabsPage({*})", {url: a.url, text: a.text})
            },
            resize: function (e) {
                var a = layui.router(),
                    i = a.path.join("-");
