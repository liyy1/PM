layui.define(["laytpl", "layer"], function(e) {
    ...
    i.exit = function(e) {
        a.msg('您已超时，请重新登录！', {icon: 5,time: 2000}, function(){
    ...
    i.req = function(e) {
        ...
        return e.data = e.data || {}, e.headers = e.headers || {}, delete e.success, delete e.error,
        t.ajax(t.extend({
            type: "post",
            dataType: "json",
            success: function(t) {
                ...
                else if(t[o.statusName] == a.error) i.error(t[o.msgName]);
                else if(t[o.statusName] == a.timeout) i.exit();
                else if(t[o.statusName] == a.noAuth) i.error("抱歉，您没有权限访问该页面！");
    ...
    i.popup = function(e) {
        ...
        return delete e.success, delete e.skin, a.open(t.extend({
            ...
            success: function(e, r) {
                ...
                e.append(o), o.on("click", function() { a.close(r) }), "function" == typeof n && n.apply(this, arguments)
            }
        }, e))
    },
    ...
    d.prototype.content = function(e, n) {
        var a = this;
        layui.router();
        console.log(e);
        console.log(n);
        console.log(n);
        return t("#" + s).children(".layadmin-loading").remove(), i.loading(a.container), t.ajax({
            url: e,
            type: "get",
            dataType: "html",
            success: function(e) {
    ...
    d.prototype.parse = function(e, a, r) {
        var s = this,
            ...
            c = function(e) {
                ...
                try { e.done && new Function("d", e.done)(e.res) } catch(o) { console.error(e.dataElem[0], "\n存在错误回调脚本\n\n", o) }
            },
            y = layui.router();
        ...
        for(var p = u.length; p > 0; p--) ! function() {
            ...
            try { r = new Function("return " + r + ";")() } catch(d) { o.error("lay-data: " + d.message), r = {} }
            try { s = new Function("return " + s + ";")() } catch(d) { o.error("lay-headers: " + d.message), s = s || {} } a ? i.req({ type: e.attr("lay-type") || "get", url: a, data: r, dataType: "json", headers: s, success: function(n) { c({ dataElem: e, res: n, done: t }) } }) : c({ dataElem: e, done: t })
        }();
        return s
    },
    ...
    d.prototype.refresh = function(e) {
        ...
        return t.id != a ? t : (t.parse(t.container, "refresh", function() { t.container.siblings('[lay-templateid="' + t.id + '"]:last').remove(), "function" == typeof e && e() }), t)
    },
