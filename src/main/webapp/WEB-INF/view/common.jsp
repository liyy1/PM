...
<link href="<%=basePath %>my/js/easyui/insdep.easyui.min.css" rel="stylesheet" type="text/css">
<link href="<%=basePath %>my/js/easyui/icon.css" rel="stylesheet" type="text/css">
<link href="<%=basePath %>my/js/layui/css/layui.css" rel="stylesheet" type="text/css">
<link href="<%=basePath %>my/css/admin.css" rel="stylesheet" type="text/css">
